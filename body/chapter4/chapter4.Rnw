...
Se puede observar en el cuadro -- como el VaR para cada estrategia varía en función de la precisión del modelo como es de esperar. Para los índices con mayor precisión el VaR es menor y por lo tanto el ES. 